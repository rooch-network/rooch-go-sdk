...
import (
	...
	"github.com/rooch-network/rooch-go-sdk/crypto/ed25519"
...
func (s *Session) SignTransaction(tx *types.Transaction) (*transactions2.Authenticator, error) {
...
func (s *Session) build(client *client.RoochClient, signer crypto.Signer) (*Session, error) {
	...
	tx.CallFunction(types.FunctionCall{
