...
const rawTransactionPrehashStr = "ROOCH::RawTransaction"
...
const rawTransactionWithDataPrehashStr = "ROOCH::RawTransactionWithData"
...
type MultiAgentRawTransactionWithData struct {
	...
	SecondarySigners []types.AccountAddress
}
...
func (txn *MultiAgentRawTransactionWithData) UnmarshalBCS(des *bcs.Deserializer) {
	...
	txn.SecondarySigners = bcs.DeserializeSequence[types.AccountAddress](des)
}
...
func (txn *MultiAgentWithFeePayerRawTransactionWithData) UnmarshalBCS(des *bcs.Deserializer) {
	...
	des.Struct(txn.RawTxn)
	txn.SecondarySigners = bcs.DeserializeSequence[types.AccountAddress](des)
	txn.FeePayer = &types.AccountAddress{}
