...
//func (key *Ed25519PrivateKey) SignTransaction(tx transactions.Transaction) (transactions.Authenticator, error) {
//	//TODO implement me
//	panic("implement me")
//}

//func (key *Ed25519PrivateKey) GetKeyScheme() SignatureScheme {
//	//TODO implement me
//	panic("implement me")
//}
...
//
//	func (key *Ed25519PrivateKey) Sign(msg []byte) (signature Signature, err error) {
//		// Can't error
...
// Sign signs a message and returns the raw [Signature] without a [VerifyingKey] for verification
//
// Never returns an error.
//
// Implements:
//   - [Signer]
func (key *Ed25519PrivateKey) Sign(msg []byte) (sig Signature, err error) {
	sigBytes := ed25519.Sign(key.Inner, msg)
	return &Ed25519Signature{Inner: [64]byte(sigBytes)}, nil
}

// Sign signs a message and returns the raw [Authenticator]
//
// Never returns an error.
//
// Implements:
...
func (key *Ed25519PrivateKey) SignTransaction(tx transactions.Transaction) (transactions.Authenticator, error) {
	...
	//op, ok := key.(Signer)
	return RoochAuthValidator(tx.Data.Hash(), key)
}

// AuthKey gives the [AuthenticationKey] associated with the [Signer]
func (key *Ed25519PrivateKey) GetRoochAddress() address.RoochAddress {
	//return this.getPublicKey().toAddress()

	return key.GetPublicKey().ToRoochAddress()
}
...
// Implements:
//   - [Signer]
func (key *Ed25519PrivateKey) GetPublicKey() PublicKey {
...
// // Implements:
// //   - [PublicKey]
func (key *Ed25519PublicKey) Scheme() DeriveScheme {
	return Ed25519DeriveScheme
}
