...
func (o *Block) UnmarshalJSON(b []byte) error {
	type inner struct {
		...
		BlockHeight    types.U64         `json:"block_height"`
		BlockTimestamp types.U64         `json:"block_timestamp"`
		FirstVersion   types.U64         `json:"first_version"`
		LastVersion    types.U64         `json:"last_version"`
