...
// Signature is an enum of all possible signatures on Rooch
//
...
type FeePayerSignature struct {
	FeePayerAddress          *address.AccountAddress   `json:"fee_payer_address"`
	FeePayerSigner           *Signature                `json:"fee_payer_signer"`
	SecondarySignerAddresses []*address.AccountAddress `json:"secondary_signer_addresses"`
