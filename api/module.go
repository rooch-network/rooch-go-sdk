...
// MoveComponentId is an id for a struct, function, or other type e.g. 0x1::gas_coin::RGas
type MoveComponentId = string

// MoveModule describes the abilities and types associated with a specific module.
type MoveModule struct {
	Address          *address.AccountAddress `json:"address"`           // Address is the address of the module e.g. 0x1
