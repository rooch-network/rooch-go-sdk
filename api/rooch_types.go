...
type CallScript struct {
	...
	Args     []Args          `json:"args"`
	TypeArgs []types.TypeTag `json:"type_args"`
}
...
type CallFunctionArgs struct {
	*FunctionArgs                 // Embed FunctionArgs
	...
	TypeArgs      []types.TypeTag `json:"type_args,omitempty"`
}

// NewCallFunctionArgs creates a new CallFunctionArgs instance
func NewCallFunctionArgs(funcArgs *FunctionArgs, args []Args, typeArgs []types.TypeTag) *CallFunctionArgs {
